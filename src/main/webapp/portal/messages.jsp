...
<head>
    ...
    <title>Databound :: Messages</title>
        ...
        <div class="ui grid">
            <div class="four wide column">
                <div class="ui breadcrumb">
                    ...
                    <div class="divider">
                        /
                    </div><a class="active section">My Activity</a>
                </div>
            </div>
        </div>
        <br /><br />
...
//                    }
                    ...
                    out.println(" <div class='item'> <img class='ui avatar image' src='"+userdao.getAvatarURL(mentryUID)+"'>");
