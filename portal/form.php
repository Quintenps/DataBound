...
<h3>Form Presets</h3>
<div class="row">
<button class="ui button">Minimum</button>
<button class="ui button green">Personal</button>
<button class="ui button red">Very personal</button>
<button class="ui button blue">Business</button>
<button class="ui button orange">Everything</button>
</div>
</div><br /><br />
